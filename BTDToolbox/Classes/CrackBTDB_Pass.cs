...
namespace BTDToolbox.Classes
{
    class CrackBTDB_Pass
    {
        ...
        public void HandleTools()
        {
            ...
            DialogResult reuslt = MessageBox.Show("Unfortunately it will take up to 15 minutes to download the necessary tools. This is a One Time thing.\n\nDo you wish to continue?", "Do you wish to continue?", MessageBoxButtons.YesNo);
        ...
        public void DownloadTools()
        {
            ...
            string DirPropmts_url = "https://www.dropbox.com/s/9xumg3cvo3gbo5x/Directory_Prompts.reg?dl=0";
                ...
                if (GetOS_Type() == "64")    //Get 64bit version of tools, otherwise get 32bit version
                {
                    ...
                    strings2_url = "https://www.dropbox.com/s/6hiifxlffqrizeu/john-1.9.0-jumbo-1-win64.zip?dl=0";
                    johntr_url = "https://www.openwall.com/john/k/john-1.9.0-jumbo-1-win64.zip";
                }
                else
                {
                    strings2_url = "http://split-code.com/files/strings2_x86_v1-2.zip";
                    johntr_url = "https://www.openwall.com/john/k/john-1.9.0-jumbo-1-win32.zip";
                }
            ...
            Client.DownloadFile(strings2_url, Strings2Dir + "\\strings2.zip");
                ConsoleHandler.appendLog("Finished downloading strings2.");

                ConsoleHandler.appendLog("Downloading johntr. Unfortunately this will take up to 15 minutes...\n>> If the program freezes, just leave it.");
